...
public class ItemImageService {
	...
	public ResponseEntity<Object> addItemImage(ItemImages img, long itemId) throws Exception {
	...
	public ResponseEntity<?> deleteItemImage(long itemId, long itemImageId) throws Exception {
